...
import org.souldbminer.reallyinspace.procedures.CraftMaskProcedure;
...
public class CraftDiamondsGui extends ReallyinspaceModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public CraftDiamondsGui(ReallyinspaceModElements instance) {
		super(instance, 265);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("craft_diamonds"));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote()) {
				ReallyinspaceMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("reallyinspace:textures/craft_diamonds.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(MatrixStack ms, float par1, int par2, int par3) {
			...
			Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("reallyinspace:textures/h1n1p.png"));
			this.blit(ms, this.guiLeft + 150, this.guiTop + 34, 0, 0, 16, 16, 16, 16);
			Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("reallyinspace:textures/modlogo.png"));
			this.blit(ms, this.guiLeft + 6, this.guiTop + 61, 0, 0, 16, 16, 16, 16);
		}
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + 33, this.guiTop + 61, 45, 20, new StringTextComponent("Craft"), e -> {
		...
		if (buttonID == 0) {
			{
				...
				CraftMaskProcedure.executeProcedure($_dependencies);
			}
		}
	}
