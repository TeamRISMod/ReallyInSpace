...
public class CboardItem extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:cboard")
	public static final Item block = null;
	public CboardItem(ReallyinspaceModElements instance) {
		super(instance, 223);
	}
