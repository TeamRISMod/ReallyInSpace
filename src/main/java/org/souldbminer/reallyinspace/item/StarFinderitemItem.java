...
public class StarFinderitemItem extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:star_finderitem")
	public static final Item block = null;
	public StarFinderitemItem(ReallyinspaceModElements instance) {
		super(instance, 238);
	}
