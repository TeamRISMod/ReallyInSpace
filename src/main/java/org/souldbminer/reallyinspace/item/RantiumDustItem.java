...
public class RantiumDustItem extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:rantium_dust")
	public static final Item block = null;
	public RantiumDustItem(ReallyinspaceModElements instance) {
		super(instance, 94);
	}
