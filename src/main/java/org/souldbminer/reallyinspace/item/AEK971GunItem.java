...
public class AEK971GunItem extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:aek_971_gun")
	public static final Item block = null;
	public AEK971GunItem(ReallyinspaceModElements instance) {
		super(instance, 250);
	}
