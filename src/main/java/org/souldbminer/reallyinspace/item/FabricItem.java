...
public class FabricItem extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:fabric")
	public static final Item block = null;
	public FabricItem(ReallyinspaceModElements instance) {
		super(instance, 257);
	}
