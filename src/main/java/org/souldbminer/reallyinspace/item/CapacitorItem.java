...
public class CapacitorItem extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:capacitor")
	public static final Item block = null;
	public CapacitorItem(ReallyinspaceModElements instance) {
		super(instance, 226);
	}
