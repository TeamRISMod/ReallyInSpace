...
import org.souldbminer.reallyinspace.procedures.HammerProcProcedure;
...
public class HammerItem extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:hammer")
	public static final Item block = null;
	public HammerItem(ReallyinspaceModElements instance) {
		super(instance, 259);
	}
		...
		elements.items.add(() -> new ItemToolCustom() {
			...
			public boolean onBlockDestroyed(ItemStack itemstack, World world, BlockState bl, BlockPos pos, LivingEntity entity) {
				...
				int z = pos.getZ();
				{
					...
					HammerProcProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
