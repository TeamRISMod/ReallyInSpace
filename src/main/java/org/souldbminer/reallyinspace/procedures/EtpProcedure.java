...
public class EtpProcedure extends ReallyinspaceModElements.ModElement {
	public EtpProcedure(ReallyinspaceModElements instance) {
		super(instance, 59);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ReallyinspaceMod.LOGGER.warn("Failed to load dependency entity for procedure Etp!");
			return;
		}
