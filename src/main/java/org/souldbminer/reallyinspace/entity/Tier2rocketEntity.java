...
public class Tier2rocketEntity extends ReallyinspaceModElements.ModElement {
	public static EntityType entity = null;
	public Tier2rocketEntity(ReallyinspaceModElements instance) {
		super(instance, 85);
			...
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelrocketmodel(), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("reallyinspace:textures/rket.png");
					}
				};
			});
		}
