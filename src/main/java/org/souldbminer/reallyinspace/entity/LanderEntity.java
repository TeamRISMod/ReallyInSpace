...
public class LanderEntity extends ReallyinspaceModElements.ModElement {
	public static EntityType entity = null;
	public LanderEntity(ReallyinspaceModElements instance) {
		super(instance, 28);
			...
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				return new MobRenderer(renderManager, new Modellander(), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("reallyinspace:textures/lander.png");
					}
				};
			});
		}
