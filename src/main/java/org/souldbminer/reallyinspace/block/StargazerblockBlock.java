...
public class StargazerblockBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:stargazerblock")
	public static final Block block = null;
	public StargazerblockBlock(ReallyinspaceModElements instance) {
		super(instance, 236);
	}
