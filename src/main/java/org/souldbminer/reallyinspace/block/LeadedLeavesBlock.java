...
public class LeadedLeavesBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:leaded_leaves")
	public static final Block block = null;
	public LeadedLeavesBlock(ReallyinspaceModElements instance) {
		super(instance, 273);
	}
