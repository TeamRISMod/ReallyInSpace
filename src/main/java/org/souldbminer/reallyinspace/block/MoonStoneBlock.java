...
public class MoonStoneBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:moon_stone")
	public static final Block block = null;
	public MoonStoneBlock(ReallyinspaceModElements instance) {
		super(instance, 90);
	}
