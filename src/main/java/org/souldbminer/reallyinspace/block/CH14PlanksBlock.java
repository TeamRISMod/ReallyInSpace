...
public class CH14PlanksBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:ch_14_planks")
	public static final Block block = null;
	public CH14PlanksBlock(ReallyinspaceModElements instance) {
		super(instance, 117);
	}
