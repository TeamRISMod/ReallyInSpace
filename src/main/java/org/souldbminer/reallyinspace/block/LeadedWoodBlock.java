...
public class LeadedWoodBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:leaded_wood")
	public static final Block block = null;
	public LeadedWoodBlock(ReallyinspaceModElements instance) {
		super(instance, 270);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(0.2f, 0.3169786384922227f).setLightLevel(s -> 0)
					.harvestLevel(0).harvestTool(ToolType.AXE));
			setRegistryName("leaded_wood");
		}
