...
public class SodiumPlanksBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:sodium_planks")
	public static final Block block = null;
	public SodiumPlanksBlock(ReallyinspaceModElements instance) {
		super(instance, 288);
	}
