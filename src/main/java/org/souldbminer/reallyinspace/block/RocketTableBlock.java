...
public class RocketTableBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:rocket_table")
	public static final Block block = null;
	public RocketTableBlock(ReallyinspaceModElements instance) {
		super(instance, 245);
	}
