...
public class CH14LeavesBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:ch_14_leaves")
	public static final Block block = null;
	public CH14LeavesBlock(ReallyinspaceModElements instance) {
		super(instance, 118);
	}
