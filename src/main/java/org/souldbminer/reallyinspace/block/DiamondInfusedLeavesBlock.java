...
public class DiamondInfusedLeavesBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:diamond_infused_leaves")
	public static final Block block = null;
	public DiamondInfusedLeavesBlock(ReallyinspaceModElements instance) {
		super(instance, 305);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("diamond_infused_leaves");
		}
