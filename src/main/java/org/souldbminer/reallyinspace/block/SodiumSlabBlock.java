...
public class SodiumSlabBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:sodium_slab")
	public static final Block block = null;
	public SodiumSlabBlock(ReallyinspaceModElements instance) {
		super(instance, 291);
	}
