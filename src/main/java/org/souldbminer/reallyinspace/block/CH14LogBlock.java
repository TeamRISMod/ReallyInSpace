...
public class CH14LogBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:ch_14_log")
	public static final Block block = null;
	public CH14LogBlock(ReallyinspaceModElements instance) {
		super(instance, 116);
	}
