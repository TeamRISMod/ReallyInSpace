...
public class CH15SlabBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:ch_15_slab")
	public static final Block block = null;
	public CH15SlabBlock(ReallyinspaceModElements instance) {
		super(instance, 136);
	}
