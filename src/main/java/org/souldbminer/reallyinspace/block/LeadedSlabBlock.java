...
public class LeadedSlabBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:leaded_slab")
	public static final Block block = null;
	public LeadedSlabBlock(ReallyinspaceModElements instance) {
		super(instance, 275);
	}
