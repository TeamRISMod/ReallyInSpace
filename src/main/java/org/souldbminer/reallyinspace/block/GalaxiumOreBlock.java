...
public class GalaxiumOreBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:galaxium_ore")
	public static final Block block = null;
	public GalaxiumOreBlock(ReallyinspaceModElements instance) {
		super(instance, 22);
