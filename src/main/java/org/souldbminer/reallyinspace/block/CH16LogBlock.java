...
public class CH16LogBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:ch_16_log")
	public static final Block block = null;
	public CH16LogBlock(ReallyinspaceModElements instance) {
		super(instance, 167);
	}
