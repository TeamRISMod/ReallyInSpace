...
public class MantonBlockBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:manton_block")
	public static final Block block = null;
	public MantonBlockBlock(ReallyinspaceModElements instance) {
		super(instance, 184);
	}
