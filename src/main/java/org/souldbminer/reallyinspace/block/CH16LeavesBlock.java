...
public class CH16LeavesBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:ch_16_leaves")
	public static final Block block = null;
	public CH16LeavesBlock(ReallyinspaceModElements instance) {
		super(instance, 169);
	}
