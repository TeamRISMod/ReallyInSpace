...
public class CH15PlanksBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:ch_15_planks")
	public static final Block block = null;
	public CH15PlanksBlock(ReallyinspaceModElements instance) {
		super(instance, 133);
	}
