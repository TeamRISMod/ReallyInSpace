...
public class DiamondInfusedFenceGateBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:diamond_infused_fence_gate")
	public static final Block block = null;
	public DiamondInfusedFenceGateBlock(ReallyinspaceModElements instance) {
		super(instance, 309);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("diamond_infused_fence_gate");
		}
