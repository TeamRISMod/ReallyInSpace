...
public class SodiumWoodBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:sodium_wood")
	public static final Block block = null;
	public SodiumWoodBlock(ReallyinspaceModElements instance) {
		super(instance, 286);
	}
