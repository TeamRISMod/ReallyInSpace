...
public class MartianPlanksBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:martian_planks")
	public static final Block block = null;
	public MartianPlanksBlock(ReallyinspaceModElements instance) {
		super(instance, 16);
	}
