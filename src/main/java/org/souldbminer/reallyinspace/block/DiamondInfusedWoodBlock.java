...
public class DiamondInfusedWoodBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:diamond_infused_wood")
	public static final Block block = null;
	public DiamondInfusedWoodBlock(ReallyinspaceModElements instance) {
		super(instance, 302);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("diamond_infused_wood");
		}
