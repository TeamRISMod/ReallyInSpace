...
public class MartianStoneBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:martian_stone")
	public static final Block block = null;
	public MartianStoneBlock(ReallyinspaceModElements instance) {
		super(instance, 25);
	}
