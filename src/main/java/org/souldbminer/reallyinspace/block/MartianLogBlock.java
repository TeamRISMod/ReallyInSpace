...
public class MartianLogBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:martian_log")
	public static final Block block = null;
	public MartianLogBlock(ReallyinspaceModElements instance) {
		super(instance, 15);
	}
