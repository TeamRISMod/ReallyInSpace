...
public class SodiumFenceBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:sodium_fence")
	public static final Block block = null;
	public SodiumFenceBlock(ReallyinspaceModElements instance) {
		super(instance, 292);
	}
