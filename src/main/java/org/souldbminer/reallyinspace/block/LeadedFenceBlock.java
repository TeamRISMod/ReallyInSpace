...
public class LeadedFenceBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:leaded_fence")
	public static final Block block = null;
	public LeadedFenceBlock(ReallyinspaceModElements instance) {
		super(instance, 276);
	}
