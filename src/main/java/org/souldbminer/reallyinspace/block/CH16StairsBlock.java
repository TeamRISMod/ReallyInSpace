...
public class CH16StairsBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:ch_16_stairs")
	public static final Block block = null;
	public CH16StairsBlock(ReallyinspaceModElements instance) {
		super(instance, 170);
	}
