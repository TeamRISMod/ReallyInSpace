...
public class CH15WoodBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:ch_15_wood")
	public static final Block block = null;
	public CH15WoodBlock(ReallyinspaceModElements instance) {
		super(instance, 131);
	}
