...
public class CH14StairsBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:ch_14_stairs")
	public static final Block block = null;
	public CH14StairsBlock(ReallyinspaceModElements instance) {
		super(instance, 119);
	}
