...
public class CH14FenceBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:ch_14_fence")
	public static final Block block = null;
	public CH14FenceBlock(ReallyinspaceModElements instance) {
		super(instance, 121);
	}
