...
public class MartianSlabBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:martian_slab")
	public static final Block block = null;
	public MartianSlabBlock(ReallyinspaceModElements instance) {
		super(instance, 19);
	}
