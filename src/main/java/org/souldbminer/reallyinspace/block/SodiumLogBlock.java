...
public class SodiumLogBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:sodium_log")
	public static final Block block = null;
	public SodiumLogBlock(ReallyinspaceModElements instance) {
		super(instance, 287);
	}
