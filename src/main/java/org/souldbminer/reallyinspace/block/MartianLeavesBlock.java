...
public class MartianLeavesBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:martian_leaves")
	public static final Block block = null;
	public MartianLeavesBlock(ReallyinspaceModElements instance) {
		super(instance, 17);
	}
