...
public class CH16PlanksBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:ch_16_planks")
	public static final Block block = null;
	public CH16PlanksBlock(ReallyinspaceModElements instance) {
		super(instance, 168);
	}
