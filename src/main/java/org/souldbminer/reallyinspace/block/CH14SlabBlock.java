...
public class CH14SlabBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:ch_14_slab")
	public static final Block block = null;
	public CH14SlabBlock(ReallyinspaceModElements instance) {
		super(instance, 120);
	}
