...
public class NASAStatoionBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:nasa_statoion")
	public static final Block block = null;
	public NASAStatoionBlock(ReallyinspaceModElements instance) {
		super(instance, 210);
	}
