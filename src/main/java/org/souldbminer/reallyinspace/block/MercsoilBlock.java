...
public class MercsoilBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:mercsoil")
	public static final Block block = null;
	public MercsoilBlock(ReallyinspaceModElements instance) {
		super(instance, 13);
	}
