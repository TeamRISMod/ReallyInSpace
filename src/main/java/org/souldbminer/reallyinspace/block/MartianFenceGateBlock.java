...
public class MartianFenceGateBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:martian_fence_gate")
	public static final Block block = null;
	public MartianFenceGateBlock(ReallyinspaceModElements instance) {
		super(instance, 21);
	}
