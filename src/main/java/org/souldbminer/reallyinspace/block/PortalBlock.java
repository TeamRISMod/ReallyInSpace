...
public class PortalBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:portal")
	public static final Block block = null;
	public PortalBlock(ReallyinspaceModElements instance) {
		super(instance, 9);
	}
