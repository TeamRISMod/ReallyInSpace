...
public class CH16FenceGateBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:ch_16_fence_gate")
	public static final Block block = null;
	public CH16FenceGateBlock(ReallyinspaceModElements instance) {
		super(instance, 173);
	}
