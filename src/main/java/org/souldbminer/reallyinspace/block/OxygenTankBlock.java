...
public class OxygenTankBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:oxygen_tank")
	public static final Block block = null;
	@ObjectHolder("reallyinspace:oxygen_tank")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public OxygenTankBlock(ReallyinspaceModElements instance) {
		super(instance, 254);
