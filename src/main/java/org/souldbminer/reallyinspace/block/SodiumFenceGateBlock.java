...
public class SodiumFenceGateBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:sodium_fence_gate")
	public static final Block block = null;
	public SodiumFenceGateBlock(ReallyinspaceModElements instance) {
		super(instance, 293);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("sodium_fence_gate");
		}
