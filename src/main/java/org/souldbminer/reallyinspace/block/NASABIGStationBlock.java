...
public class NASABIGStationBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:nasabig_station")
	public static final Block block = null;
	public NASABIGStationBlock(ReallyinspaceModElements instance) {
		super(instance, 212);
	}
