...
public class DiamondInfusedStairsBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:diamond_infused_stairs")
	public static final Block block = null;
	public DiamondInfusedStairsBlock(ReallyinspaceModElements instance) {
		super(instance, 306);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("diamond_infused_stairs");
		}
