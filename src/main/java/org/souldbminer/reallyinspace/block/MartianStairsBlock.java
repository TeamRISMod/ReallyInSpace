...
public class MartianStairsBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:martian_stairs")
	public static final Block block = null;
	public MartianStairsBlock(ReallyinspaceModElements instance) {
		super(instance, 18);
	}
