...
public class SodiumLeavesBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:sodium_leaves")
	public static final Block block = null;
	public SodiumLeavesBlock(ReallyinspaceModElements instance) {
		super(instance, 289);
	}
