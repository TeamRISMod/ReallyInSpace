...
public class CH16WoodBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:ch_16_wood")
	public static final Block block = null;
	public CH16WoodBlock(ReallyinspaceModElements instance) {
		super(instance, 166);
	}
