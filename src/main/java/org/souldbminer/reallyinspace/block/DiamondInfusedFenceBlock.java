...
public class DiamondInfusedFenceBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:diamond_infused_fence")
	public static final Block block = null;
	public DiamondInfusedFenceBlock(ReallyinspaceModElements instance) {
		super(instance, 308);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("diamond_infused_fence");
		}
