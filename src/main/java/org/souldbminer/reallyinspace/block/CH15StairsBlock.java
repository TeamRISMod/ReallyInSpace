...
public class CH15StairsBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:ch_15_stairs")
	public static final Block block = null;
	public CH15StairsBlock(ReallyinspaceModElements instance) {
		super(instance, 135);
	}
