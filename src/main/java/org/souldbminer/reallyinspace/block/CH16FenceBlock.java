...
public class CH16FenceBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:ch_16_fence")
	public static final Block block = null;
	public CH16FenceBlock(ReallyinspaceModElements instance) {
		super(instance, 172);
	}
