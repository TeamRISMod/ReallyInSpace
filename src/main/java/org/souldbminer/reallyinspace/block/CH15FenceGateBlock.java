...
public class CH15FenceGateBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:ch_15_fence_gate")
	public static final Block block = null;
	public CH15FenceGateBlock(ReallyinspaceModElements instance) {
		super(instance, 138);
	}
