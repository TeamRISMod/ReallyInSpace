...
public class CH15FenceBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:ch_15_fence")
	public static final Block block = null;
	public CH15FenceBlock(ReallyinspaceModElements instance) {
		super(instance, 137);
	}
