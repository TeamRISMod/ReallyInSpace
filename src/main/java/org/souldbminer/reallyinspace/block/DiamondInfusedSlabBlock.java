...
public class DiamondInfusedSlabBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:diamond_infused_slab")
	public static final Block block = null;
	public DiamondInfusedSlabBlock(ReallyinspaceModElements instance) {
		super(instance, 307);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("diamond_infused_slab");
		}
