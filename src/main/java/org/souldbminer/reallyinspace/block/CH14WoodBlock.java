...
public class CH14WoodBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:ch_14_wood")
	public static final Block block = null;
	public CH14WoodBlock(ReallyinspaceModElements instance) {
		super(instance, 115);
	}
