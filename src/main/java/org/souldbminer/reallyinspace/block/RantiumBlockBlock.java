...
public class RantiumBlockBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:rantium_block")
	public static final Block block = null;
	public RantiumBlockBlock(ReallyinspaceModElements instance) {
		super(instance, 96);
	}
