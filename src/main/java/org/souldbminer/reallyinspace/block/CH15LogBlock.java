...
public class CH15LogBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:ch_15_log")
	public static final Block block = null;
	public CH15LogBlock(ReallyinspaceModElements instance) {
		super(instance, 132);
	}
