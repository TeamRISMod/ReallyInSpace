...
public class CH16SlabBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:ch_16_slab")
	public static final Block block = null;
	public CH16SlabBlock(ReallyinspaceModElements instance) {
		super(instance, 171);
	}
