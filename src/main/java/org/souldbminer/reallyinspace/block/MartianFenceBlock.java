...
public class MartianFenceBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:martian_fence")
	public static final Block block = null;
	public MartianFenceBlock(ReallyinspaceModElements instance) {
		super(instance, 20);
	}
