...
public class SodiumStairsBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:sodium_stairs")
	public static final Block block = null;
	public SodiumStairsBlock(ReallyinspaceModElements instance) {
		super(instance, 290);
	}
