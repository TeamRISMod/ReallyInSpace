...
public class DiamondInfusedPlanksBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:diamond_infused_planks")
	public static final Block block = null;
	public DiamondInfusedPlanksBlock(ReallyinspaceModElements instance) {
		super(instance, 304);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("diamond_infused_planks");
		}
