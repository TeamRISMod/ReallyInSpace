...
public class RantiumOreBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:rantium_ore")
	public static final Block block = null;
	public RantiumOreBlock(ReallyinspaceModElements instance) {
		super(instance, 95);
