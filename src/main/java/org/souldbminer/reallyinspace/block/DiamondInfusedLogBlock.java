...
public class DiamondInfusedLogBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:diamond_infused_log")
	public static final Block block = null;
	public DiamondInfusedLogBlock(ReallyinspaceModElements instance) {
		super(instance, 303);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("diamond_infused_log");
		}
