...
public class CH14FenceGateBlock extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:ch_14_fence_gate")
	public static final Block block = null;
	public CH14FenceGateBlock(ReallyinspaceModElements instance) {
		super(instance, 122);
	}
