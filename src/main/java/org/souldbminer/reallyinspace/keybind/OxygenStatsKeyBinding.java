...
package org.souldbminer.reallyinspace.keybind;
...
public class OxygenStatsKeyBinding extends ReallyinspaceModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public OxygenStatsKeyBinding(ReallyinspaceModElements instance) {
		super(instance, 262);
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.oxygen_stats", GLFW.GLFW_KEY_Y, "key.categories.reallyinspace");
