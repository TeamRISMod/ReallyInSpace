...
public class FixingEnchantment extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:fixing")
	public static final Enchantment enchantment = null;
	public FixingEnchantment(ReallyinspaceModElements instance) {
		super(instance, 248);
	}
