...
public class MarsDimension extends ReallyinspaceModElements.ModElement {
	@ObjectHolder("reallyinspace:mars_portal")
	public static final CustomPortalBlock portal = null;
	public MarsDimension(ReallyinspaceModElements instance) {
		super(instance, 8);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("reallyinspace:mars"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("reallyinspace:mars"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos, RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("reallyinspace:mars")));
				} else {
					entity.func_242279_ag();
