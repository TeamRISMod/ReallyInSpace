...
public class CeresbiomeBiome extends ReallyinspaceModElements.ModElement {
	public static Biome biome;
	public CeresbiomeBiome(ReallyinspaceModElements instance) {
		super(instance, 88);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("reallyinspace:ceresbiome"));
			}
		}
	}
	@Override
