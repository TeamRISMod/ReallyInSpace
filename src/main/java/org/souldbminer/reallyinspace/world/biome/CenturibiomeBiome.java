...
public class CenturibiomeBiome extends ReallyinspaceModElements.ModElement {
	public static Biome biome;
	public CenturibiomeBiome(ReallyinspaceModElements instance) {
		super(instance, 86);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("reallyinspace:centuribiome"));
			}
		}
	}
	@Override
