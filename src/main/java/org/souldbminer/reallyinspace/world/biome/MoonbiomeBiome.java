...
public class MoonbiomeBiome extends ReallyinspaceModElements.ModElement {
	public static Biome biome;
	public MoonbiomeBiome(ReallyinspaceModElements instance) {
		super(instance, 91);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(MoonStoneBlock.block.getDefaultState(),
				...
				event.getRegistry().register(biome.setRegistryName("reallyinspace:moonbiome"));
			}
		}
	}
	@Override
