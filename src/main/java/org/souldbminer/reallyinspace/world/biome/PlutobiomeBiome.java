...
public class PlutobiomeBiome extends ReallyinspaceModElements.ModElement {
	public static Biome biome;
	public PlutobiomeBiome(ReallyinspaceModElements instance) {
		super(instance, 147);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("reallyinspace:plutobiome"));
			}
		}
	}
	@Override
